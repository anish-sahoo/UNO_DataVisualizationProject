...
def click3():
    global disp
    disp.configure(text='A separate window is\nnow displaying Graph 3')
    # disp3 = customtkinter.CTkLabel(root, text=" A separate window is\nnow displaying Graph 3", font=("Ariel", 20))
...
def click4():
    global disp
    disp.configure(text='A separate window is\nnow displaying Graph 4')
    # disp4 = customtkinter.CTkLabel(root, text=" A separate window is\nnow displaying Graph 4", font=("Ariel", 20))
...
# graph buttons
g1 = customtkinter.CTkButton(root, text="Restrictions for\nLight Work", command=click1, font=("Ariel", 20), height=50,
                             width=150, fg_color='green')  # actual buttons that do above commands
g1.grid(row=0, column=1, padx=10, pady=10, sticky="ewns")
g2 = customtkinter.CTkButton(root, text="Minimum working\nage for children", command=click2, font=("Ariel", 20),
                             height=50, width=150, fg_color='green')
g2.grid(row=1, column=1, padx=10, pady=10, sticky="ewns")
g3 = customtkinter.CTkButton(root, text="Overtime Restrictions\nfor children", command=click3, font=("Ariel", 20),
                             height=50, width=150, fg_color='green')
g3.grid(row=2, column=1, padx=10, pady=10, sticky="ewns")
...
slider = customtkinter.CTkSlider(master=root, from_=15, to=30, command=slider_event)
